  ...
  return (
    <div className={cn("px-8 py-6")}>
      ...
      {localSuiteNames.map((suiteName) => {
        ...
        return (
          <div key={suiteName} className="mb-4 last:mb-0">
            ...
            >
              ...
              <span className="text-sm font-semibold text-foreground">{suiteName}</span>
              <span className="text-xs text-muted-foreground ml-1">{cases.length}</span>
            </button>
                ...
                <table className="w-full text-xs text-foreground">
                  <thead>
                    <tr className="bg-card border-b border-border">
                      <th scope="col" className="px-2 py-1.5 text-left text-xs font-normal text-muted-foreground min-w-[150px]">Test Case</th>
                      <th scope="col" className="px-2 py-1.5 text-left text-xs font-normal text-muted-foreground min-w-[200px]">Steps</th>
                      <th scope="col" className="px-2 py-1.5 text-left text-xs font-normal text-muted-foreground min-w-[170px]">Expected Result</th>
                      <th scope="col" className="px-2 py-1.5 text-left text-xs font-normal text-muted-foreground min-w-[140px]">Preconditions</th>
                      <th scope="col" className="px-2 py-1.5 text-left text-xs font-normal text-muted-foreground min-w-[140px]">Test Data</th>
                      <th scope="col" className="px-2 py-1.5 text-left text-xs font-normal text-muted-foreground w-[110px]">Priority</th>
                      <th scope="col" className="px-2 py-1.5 text-left text-xs font-normal text-muted-foreground w-[90px]">Status</th>
                      <th scope="col" className="px-2 py-1.5 text-left text-xs font-normal text-muted-foreground w-[90px]">Test Layer</th>
                      <th scope="col" className="px-2 py-1.5 text-left text-xs font-normal text-muted-foreground w-[90px]">Test Type</th>
                      <th scope="col" className="px-2 py-1.5 text-left text-xs font-normal text-muted-foreground w-[90px]">Last Verified</th>
                    </tr>
                  </thead>
                  <tbody>
                    {cases.map((tc) => (
                      ...
                      >
                        <td className="px-2 py-1.5 text-xs font-normal align-top text-foreground">
                        ...
                        <td className="px-2 py-1.5 text-xs font-normal align-top">
                          <ol className="space-y-0.5 text-foreground list-none">
                            {tc.Кроки.map((step, i) => (
                              <li key={i}>{i + 1}. {step}</li>
                            ))}
                          </ol>
                        </td>
                        <td className="px-2 py-1.5 text-xs font-normal align-top text-foreground">{tc["Очікуваний результат"]}</td>
                        <td className="px-2 py-1.5 text-xs font-normal align-top text-foreground">{tc.Передумови}</td>
                        <td className="px-2 py-1.5 text-xs font-normal align-top text-foreground">{tc["Тестові дані"]}</td>
                        <td className="px-2 py-1.5 align-top"><PriorityBadge priority={tc.Пріоритет} /></td>
                        <td className="px-2 py-1.5 text-xs font-normal align-top text-muted-foreground">Not started</td>
                        <td className="px-2 py-1.5 text-xs font-normal align-top text-muted-foreground">{tc.Layer}</td>
                        <td className="px-2 py-1.5 text-xs font-normal align-top text-muted-foreground">{tc.Type}</td>
                        <td className="px-2 py-1.5 text-xs font-normal align-top text-muted-foreground"></td>
                      </tr>
                    ))}
                  </tbody>
                </table>
